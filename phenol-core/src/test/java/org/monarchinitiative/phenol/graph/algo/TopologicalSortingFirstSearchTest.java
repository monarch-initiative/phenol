...
public class TopologicalSortingFirstSearchTest extends GraphAlgoTestBase {
  ...
  public void testSimpleDagTopsortForward() {
    ...
    TopologicalSorting<Integer, IdLabeledEdge,
      DefaultDirectedGraph<Integer, IdLabeledEdge>> topSort = new TopologicalSorting<>();
    topSort.startForward(simpleDag, new VertexVisitor<Integer, IdLabeledEdge>() {
      @Override
  ...
  public void testSimpleDagTopsortReverse() {
    ...
    TopologicalSorting<Integer, IdLabeledEdge,
        DefaultDirectedGraph<Integer, IdLabeledEdge>> topSort = new TopologicalSorting<>();
    topSort.startReverse(simpleDag, new VertexVisitor<Integer, IdLabeledEdge>() {
      @Override
      public boolean visit(DefaultDirectedGraph<Integer, IdLabeledEdge> g, Integer v) {
        visited.add(v);
        return true;
  ...
  public void testSimpleLineTopsortForward() {
    ...
    TopologicalSorting<Integer, IdLabeledEdge,
        DefaultDirectedGraph<Integer, IdLabeledEdge>> topSort = new TopologicalSorting<>();
    topSort.startForward(simpleLine, new VertexVisitor<Integer, IdLabeledEdge>() {
      @Override
      public boolean visit(DefaultDirectedGraph<Integer, IdLabeledEdge> g, Integer v) {
        visited.add(v);
        return true;
  ...
  public void testSimpleLineTopsortReverse() {
    ...
    TopologicalSorting<Integer, IdLabeledEdge,
        DefaultDirectedGraph<Integer, IdLabeledEdge>> topSort = new TopologicalSorting<>();
    topSort.startReverse(simpleLine, new VertexVisitor<Integer, IdLabeledEdge>() {
      @Override
      public boolean visit(DefaultDirectedGraph<Integer, IdLabeledEdge> g, Integer v) {
        visited.add(v);
        return true;
