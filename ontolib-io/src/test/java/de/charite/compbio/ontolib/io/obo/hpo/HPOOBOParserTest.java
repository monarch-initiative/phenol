...
public class HPOOBOParserTest {
  ...
  public void testParseHPOHead() throws IOException {
    ...
    assertEquals(
        "ImmutableDirectedGraph [edgeLists={ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000001]=ImmutableVertexEdgeList [inEdges=[ImmutableEdge [source=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005], dest=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000001], id=1]], outEdges=[]], ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005]=ImmutableVertexEdgeList [inEdges=[ImmutableEdge [source=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000006], dest=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=2], ImmutableEdge [source=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000007], dest=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=3]], outEdges=[ImmutableEdge [source=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005], dest=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000001], id=1]]], ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000006]=ImmutableVertexEdgeList [inEdges=[], outEdges=[ImmutableEdge [source=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000006], dest=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=2]]], ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000007]=ImmutableVertexEdgeList [inEdges=[], outEdges=[ImmutableEdge [source=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000007], dest=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=3]]]}, edgeCount=3]",
        ontology.getGraph().toString());
    assertEquals(
        "[ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000001], ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005], ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000006], ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000007]]",
    ...
    assertEquals(
        "{1=HPOTermRelation [source=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005], dest=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000001], id=1, relationQualifier=IS_A], 2=HPOTermRelation [source=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000006], dest=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=2, relationQualifier=IS_A], 3=HPOTermRelation [source=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000007], dest=ImmutableTermID [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=3, relationQualifier=IS_A]}",
