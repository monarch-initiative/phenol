 ...
 *
 * <p>The key starts at the beginning of a line up to and excluding the first colon. The value is
 * parsed from everything after the first non-space after the colon. The value parsing depends on
 * the key.
 *
 * <p>This class is not meant to be used directly, use its sub classes instead.
 *
...
public class StanzaEntry {
   ...
   * Constructor.
   *
   * <p>Only to be used by sub classes' constructors.
   *
