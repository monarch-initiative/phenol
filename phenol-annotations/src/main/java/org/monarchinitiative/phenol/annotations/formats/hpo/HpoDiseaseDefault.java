...
class HpoDiseaseDefault implements HpoDisease {
  ...
  HpoDiseaseDefault(TermId diseaseDatabaseId,
    ...
    this.onset = Objects.requireNonNull(onset, "Onset must not be null");
...
//      .orElse(0.);
  ...
  public String toString() {
    ...
    return String.format("HpoDisease [name=%s;%s] phenotypicAbnormalities=%s, onset=%s, modesOfInheritance=%s",
