...
/**
 * Interface for generic similarity computation between two {@link TermID}s or
 * two sets of {@link TermID}s.
 *
...
public interface SimilarityComputation {
   ...
   *
   * @param t1
   *          First {@link TermID} to use
   * @param t2
   *          Second {@link TermID} to use
   ...
   *
   * @param query
   *          Query collection of {@link TermID}s to use
   * @param target
   *          Target collection of {@link TermID}s to use
   ...
   * @return asymmetric similarity score
   */
  double computeSymmetricScore(Collection<TermID> query,
