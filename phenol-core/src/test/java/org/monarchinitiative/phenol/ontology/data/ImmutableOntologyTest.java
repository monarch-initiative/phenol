...
//    assertEquals(
//        "{ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000001]=CommonTerm [id=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000001], altTermIds=[], name=term1, definition=some definition 1, comment=null, subsets=[], synonyms=[], obsolete=false, createdBy=null, creationDate=null, xrefs=[]], ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000002]=CommonTerm [termId=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000002], altTermIds=[], name=term2, definition=some definition 2, comment=null, subsets=[], termSynonyms=[], obsolete=false, createdBy=null, creationDate=null, xrefs=[]], ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000003]=Term [termId=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000003], altTermIds=[], name=term3, definition=some definition 3, comment=null, subsets=[], termSynonyms=[], obsolete=false, createdBy=null, creationDate=null, xrefs=[]], ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000004]=Term [termId=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000004], altTermIds=[], name=term4, definition=some definition 4, comment=null, subsets=[], termSynonyms=[], obsolete=false, createdBy=null, creationDate=null, xrefs=[]], ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000005]=Term [termId=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000005], altTermIds=[], name=term5, definition=some definition 5, comment=null, subsets=[], termSynonyms=[], obsolete=false, createdBy=null, creationDate=null, xrefs=[]]}",
//        ontology.getTermMap().toString());

//    assertEquals(
//        "{1=Relationship [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000001], dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000002], id=1], 2=Relationship [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000001], dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000003], id=2], 3=Relationship [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000001], dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000004], id=3], 4=Relationship [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000002], dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=4], 5=Relationship [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000003], dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=5], 6=Relationship [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000004], dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=6]}",
...
//    assertEquals(
//        "[CommonTerm [id=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000001], altTermIds=[], name=term1, definition=some definition 1, comment=null, subsets=[], synonyms=[], obsolete=false, createdBy=null, creationDate=null, xrefs=[]], Term [termId=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000002], altTermIds=[], name=term2, definition=some definition 2, comment=null, subsets=[], termSynonyms=[], obsolete=false, createdBy=null, creationDate=null, xrefs=[]], Term [termId=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000003], altTermIds=[], name=term3, definition=some definition 3, comment=null, subsets=[], termSynonyms=[], obsolete=false, createdBy=null, creationDate=null, xrefs=[]], Term [termId=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000004], altTermIds=[], name=term4, definition=some definition 4, comment=null, subsets=[], termSynonyms=[], obsolete=false, createdBy=null, creationDate=null, xrefs=[]], Term [termId=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000005], altTermIds=[], name=term5, definition=some definition 5, comment=null, subsets=[], termSynonyms=[], obsolete=false, createdBy=null, creationDate=null, xrefs=[]]]",
//        ontology.getTerms().toString());
   ...
   * [prefix=ImmutableTermPrefix [value=HP], id=0000002], id=1] 2 Relationship
   ...
   * Relationship [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000001],
   * dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000004], id=3] 4
   * Relationship [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000002],
   * dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=4] 5
   * Relationship [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000003],
   * dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000005], id=5] 6
   * Relationship [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=0000004],
