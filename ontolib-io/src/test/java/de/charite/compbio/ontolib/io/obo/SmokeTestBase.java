...
public class SmokeTestBase {
  public final static String MINIMAL_FILE = "format-version: 1.2\n\n[Term]\nid: HP:0000001\n";

  public final static String HEAD_HPO = Joiner.on("\n").join(new String[] {"format-version: 1.2",
      ...
      "synonymtypedef: HP:0045076 \"UK spelling\"", "synonymtypedef: HP:0045077 \"abbreviation\"",
      "synonymtypedef: HP:0045078 \"plural form\"", "synonymtypedef: layperson \"layperson term\"",
      "default-namespace: human_phenotype", "ontology: hp",
      ...
      "synonym: \"Abnormality of body height\" EXACT layperson []", "xref: UMLS:C4025901",
      "is_a: HP:0001507 ! Growth abnormality", "created_by: peter",
