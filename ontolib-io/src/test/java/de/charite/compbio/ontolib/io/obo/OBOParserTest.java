...
public class OBOParserTest {
  ...
  public void testAllInOneParsing() {
    ...
    assertEquals(
        "OBOFile [header=Header [entries=[StanzaEntryFormatVersion [value=1.2, getType()=FORMAT_VERSION, getTrailingModifier()=null, getComment()=null]], entryByType={FORMAT_VERSION=[StanzaEntryFormatVersion [value=1.2, getType()=FORMAT_VERSION, getTrailingModifier()=null, getComment()=null]]}], stanzas=[Stanza [type=TERM, stanzaEntries=[StanzaEntryID [id=HP:0000001, getType()=ID, getTrailingModifier()=null, getComment()=null], StanzaEntryName [name=All, getType()=NAME, getTrailingModifier()=null, getComment()=null]], entryByType={ID=[StanzaEntryID [id=HP:0000001, getType()=ID, getTrailingModifier()=null, getComment()=null]], NAME=[StanzaEntryName [name=All, getType()=NAME, getTrailingModifier()=null, getComment()=null]]}]]]",
        oboFile.toString());
  }
  ...
  public void testEventBasedParsing() {
    ...
    assertEquals(
        "[Stanza [type=TERM, stanzaEntries=[StanzaEntryID [id=HP:0000001, getType()=ID, getTrailingModifier()=null, getComment()=null], StanzaEntryName [name=All, getType()=NAME, getTrailingModifier()=null, getComment()=null]], entryByType={ID=[StanzaEntryID [id=HP:0000001, getType()=ID, getTrailingModifier()=null, getComment()=null]], NAME=[StanzaEntryName [name=All, getType()=NAME, getTrailingModifier()=null, getComment()=null]]}]]",
