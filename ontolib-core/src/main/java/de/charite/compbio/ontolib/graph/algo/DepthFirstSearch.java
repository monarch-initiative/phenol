...
/**
 * Depth-first-search for {@link DirectedGraph}s using the <b>visitor pattern</b>.                           asdf
 *
...
public interface DepthFirstSearch<V, E extends Edge<V>> {
  ...
  /**
   * Start depth-first-search using forward edges in Graph <code>g</code> starting from
  ...
  /**
   * Start depth-first-search using reverse edges in Graph <code>g</code> starting from
   * <code>v</code>, using {@link VertexVisitor} <code>visitor</code>.
   *
   * @param g {@link DirectedGraph} to work on
   * @param v Vertex to start on
