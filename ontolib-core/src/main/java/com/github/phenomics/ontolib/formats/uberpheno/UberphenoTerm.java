...
public class UberphenoTerm implements Term {
   ...
   */
  public UberphenoTerm(TermId id, List<TermId> altTermIds, String name, String definition, String comment,
  ...
  public String toString() {
    return "UberphenoTerm [id=" + id + ", altTermIds=" + altTermIds + ", name=" + name + ", definition="
