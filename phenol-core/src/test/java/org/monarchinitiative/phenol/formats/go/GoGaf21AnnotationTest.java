...
public class GoGaf21AnnotationTest {
  ...
  public void testCandidaAlbicans() throws PhenolException {
    ...
    TermId expected = new TermId(new TermPrefix("CGD"),"CAL0000196141");
    assertEquals(expected,annot.getDbObjectTermId());
    TermId goId = TermId.constructWithPrefix("GO:0005634");
  ...
  public void testMouse() throws PhenolException {
    ...
    GoGaf21Annotation annot = new GoGaf21Annotation(F);
    TermId expected = TermId.constructWithPrefix("MGI:1918911");
    assertEquals(expected,annot.getDbObjectTermId());
    TermId goId = TermId.constructWithPrefix("GO:0005575");
  }
  ...
  public void testYeast() throws PhenolException {
    ...
    GoGaf21Annotation annot = new GoGaf21Annotation(F);
    TermId expected = TermId.constructWithPrefix("SGD:S000002318");
    assertEquals(expected,annot.getDbObjectTermId());
    TermId goId = TermId.constructWithPrefix("GO:0000187");
  }
  ...
  public void testDog() throws PhenolException {
    ...
    GoGaf21Annotation annot = new GoGaf21Annotation(F);
    TermId expected = TermId.constructWithPrefix("UniProtKB:A0A075B5H7");
    assertEquals(expected,annot.getDbObjectTermId());
    TermId goId = TermId.constructWithPrefix("GO:0006412");
  }
  ...
  public void testEcoli() throws PhenolException {
    ...
    GoGaf21Annotation annot = new GoGaf21Annotation(F);
    TermId expected = TermId.constructWithPrefix("UniProtKB:P0A776");
    assertEquals(expected,annot.getDbObjectTermId());
    TermId goId = TermId.constructWithPrefix("GO:0034353");
  }
  ...
  public void testRat() throws PhenolException {
    ...
    GoGaf21Annotation annot = new GoGaf21Annotation(F);
    TermId expected = TermId.constructWithPrefix("RGD:10059729");
    assertEquals(expected,annot.getDbObjectTermId());
    TermId goId = TermId.constructWithPrefix("GO:0000149");
  ...
  public void testChicken() throws PhenolException {
    ...
    GoGaf21Annotation annot = new GoGaf21Annotation(F);
    TermId expected = TermId.constructWithPrefix("UniProtKB:A0A088BIK7");
    assertEquals(expected,annot.getDbObjectTermId());
    TermId goId = TermId.constructWithPrefix("GO:0005882");
  ...
  public void testHuman() throws PhenolException {
    ...
    GoGaf21Annotation annot = new GoGaf21Annotation(F);
    TermId expected = TermId.constructWithPrefix("UniProtKB:A0A024R161");
    assertEquals(expected,annot.getDbObjectTermId());
    TermId goId = TermId.constructWithPrefix("GO:0007186");
