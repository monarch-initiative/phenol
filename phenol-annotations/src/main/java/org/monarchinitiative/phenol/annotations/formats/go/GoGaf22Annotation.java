...
public class GoGaf22Annotation implements TermAnnotation {
     ...
     * Note that the lines have 17 fields (the latter is the extended format).
    ...
    public static GoGaf22Annotation parseAnnotation(String line) throws PhenolException {
        ...
        return new GoGaf22Annotation(arr);
    }
