...
public class CellOntologyMap extends HpoTermsForMap {
  ...
  public CellOntologyMap() {
    ...
    cellOntologyMap.put(HEPATIC_STELLATE_CELL, ABNORMAL_LIVER_MORPHOLOGY);
    cellOntologyMap.put(HEPATOCYTE, ABNORMAL_LIVER_MORPHOLOGY);
    ...
    cellOntologyMap.put(KIDNEY_EPITHELIAL_CELL, ABNORMAL_RENAL_MORPHOLOGY);
    ...
    cellOntologyMap.put(MAMMARY_EPITHELIAL_CELL, ABNORMAL_BREAST_MORPHOLOGY);
    cellOntologyMap.put(MAST_CELL, ABNORMAL_MAST_CELL_MORPHOLOGY);
    cellOntologyMap.put(MONOCYTE, ABNORMAL_MONOCYTE_MORPHOLOGY);
    cellOntologyMap.put(MYOBLAST, ABNORMAL_SKELETAL_MUSCLE_MORPHOLOGY);
    ...
    cellOntologyMap.put(SKELETAL_MUSCLE_CELL, ABNORMAL_SKELETAL_MUSCLE_MORPHOLOGY);
    cellOntologyMap.put(SKIN_FIBROBLAST, ABNORMAL_SKIN_MORPHOLOGY);
    ...
    cellOntologyMap.put(UTERINE_SMOOTH_MUSCLE_CELL, ABNORMAL_UTERUS_MORPHOLOGY);
    cellOntologyMap.put(VASCULAR_ASSOCIATED_SMOOTH_MUSCLE_CELL, ABNORMAL_VASCULAR_MORPHOLOGY);
