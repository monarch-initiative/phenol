  ...
  public static HpoDisease marfanSyndrome() {
    ...
    List<HpoDiseaseAnnotation> annotations = List.of(
      HpoDiseaseAnnotation.of(TermId.of("HP:0000483"), // Astigmatism
        List.of(
          HpoDiseaseAnnotationMetadata.of(null, AnnotationFrequency.of(Ratio.of(3, 53)), List.of(), null)
        )),
      HpoDiseaseAnnotation.of(TermId.of("HP:0001377"), // Limited elbow extension
        List.of(
          HpoDiseaseAnnotationMetadata.of(null, AnnotationFrequency.of(Ratio.of(29, 199)), List.of(), null)
        )),
      HpoDiseaseAnnotation.of(TermId.of("HP:0032934"), // Spontaneous cerebrospinal fluid leak
        List.of(
          HpoDiseaseAnnotationMetadata.of(TemporalInterval.openEnd(HpoOnset.YOUNG_ADULT_ONSET.start()), HpoFrequency.VERY_RARE, List.of(), null)
        ))
    );
    ...
    return HpoDisease.of(
      diseaseName,
      databaseId,
      TemporalInterval.openEnd(Timestamp.zero()),
      annotations,
      modesOfInheritance
      );
  }
