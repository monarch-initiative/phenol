  ...
  public static HpoDisease marfanSyndrome() {
    ...
    List<HpoDiseaseAnnotation> annotations = List.of(
      FACTORY.create(TermId.of("HP:0000483"), // Astigmatism
        List.of(KnowsRatioAndMaybeTemporalRange.of(Ratio.of(3, 53), null)), noModifiersForNow,
      ...
      FACTORY.create(TermId.of("HP:0001377"), // Limited elbow extension
        List.of(KnowsRatioAndMaybeTemporalRange.of(Ratio.of(29, 199), null)), List.of(TermId.of("HP:0012832")), // bilateral
      ...
      FACTORY.create(TermId.of("HP:0032934"), // Spontaneous cerebrospinal fluid leak
        List.of(KnowsRatioAndMaybeTemporalRange.of(HpoFrequency.VERY_RARE, TemporalRange.openEnd(HpoOnset.YOUNG_ADULT_ONSET.start()))), noModifiersForNow,
