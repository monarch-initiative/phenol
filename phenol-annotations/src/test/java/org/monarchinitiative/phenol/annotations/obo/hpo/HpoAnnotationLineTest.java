...
// TODO - move these tests to HpoAnnotationLoader
@Deprecated
...
//    assertFalse(hpoAnnot.isNegated());
//    assertEquals("", hpoAnnot.fequency());
...
//    HpoDiseaseAnnotation annot = HpoAnnotationLine.toHpoAnnotation(line, ontology);
//    TermId expectedId = TermId.of("OMIM:123456");
//    assertEquals(expectedId,line.getDiseaseTermId());
//    double expectedFrequency=0.895;
//    assertEquals(expectedFrequency,annot.frequency(),EPSILON);
//  }
//
//
//
