 ...
 *
 * <p>
 * In an {@link Ontology}, there can only be one root (vertices of non-obsolete terms that have no
 * incoming "is-a" relation are roots). In the case of multiple root candidates, this class will
