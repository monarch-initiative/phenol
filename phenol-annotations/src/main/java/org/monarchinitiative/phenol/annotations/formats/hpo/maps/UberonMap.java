...
public class UberonMap extends HpoTermsForMap{
  ...
  public UberonMap() {
    ...
    uberonMap.put(BLOOD_VESSEL, ABNORMALITY_VASCULATURE);
    ...
    uberonMap.put(KIDNEY, ABNORMALITY_KIDNEY);
    uberonMap.put(LARGE_INTESTINE, ABNORMAL_LARGE_INTESTINE_MORPHOLOGY);
    uberonMap.put(LIVER, ABNORMALITY_LIVER);
    ...
    uberonMap.put(SKELETAL_MUSCLE_TISSUE, ABNORMAL_MUSCULATURE);
    uberonMap.put(SKIN_OF_BODY, ABNORMALITY_SKIN);
    ...
    uberonMap.put(UTERUS, ABNORMALITY_UTERUS);
