 ...
 * GoOboParserOLD parser = new GoOboParserOLD(new File(fileName));
 * GoOntology go;
 * try {
 *   go = parser.parse();
 * } catch (IOException e) {
 ...
 */
public final class GoOboParserOLD implements OntologyOboParser<GoOntology> {
   ...
   */
  public GoOboParserOLD(File oboFile, boolean debug) {
   ...
   * @param oboFile The OBO file to read.
   */
  public GoOboParserOLD(File oboFile) {
    this(oboFile, false);
  }
