...
public class UberphenoGeneAnnotationParserTest {
  ...
  public void testParseHpoDiseaseAnnotationHead()
    ...
    assertEquals(
        "UberphenoGeneAnnotation [entrezGeneId=90639, entrezGeneSymbol=COX19, termDescription=Hyperphosphatemia, uberphenoTermId=ImmutableTermId [prefix=TermPrefix [value=HP], id=0002905], evidenceDescription=Cox19 (MGI:1915283/MOUSE)]",
