 ...
 *
 * @param <T>
 *          {@link Term} sub class to use in {@link Ontology}
 * @param <R>
 *          {@link TermRelation} sub class to use in {@link Ontology}
 *
 * @author <a href="mailto:manuel.holtgrewe@bihealth.de">Manuel Holtgrewe</a>
 */
class ResnikOneToOneSimilarityComputation<T extends Term,
    R extends TermRelation> implements OneToOneSimilarityComputation {
