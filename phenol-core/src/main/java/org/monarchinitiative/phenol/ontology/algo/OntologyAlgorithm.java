...
public class OntologyAlgorithm {
  ...
  public static Set<TermId> getChildTerms(
      Ontology<? extends Term, ? extends Relationship> ontology, TermId parentTermId) {
   ...
   */
  public static Set<TermId> getChildTerms(
      Ontology<? extends Term, ? extends Relationship> ontology, Set<TermId> parentTermIdSet) {
    ImmutableSet.Builder<TermId> kids = new ImmutableSet.Builder<>();
  ...
  public static Set<TermId> getParentTerms(
      Ontology<? extends Term, ? extends Relationship> ontology, Set<TermId> childTermIdSet) {
   ...
   */
  public static Set<TermId> getParentTerms(
      Ontology<? extends Term, ? extends Relationship> ontology, TermId childTermId) {
  ...
  public static boolean isSubclass(
      Ontology<? extends Term, ? extends Relationship> ontology, TermId source, TermId dest) {
    return ontology.getAncestorTermIds(source).contains(dest);
  }

  public static boolean termsAreSiblings(
      Ontology<? extends Term, ? extends Relationship> ontology, TermId t1, TermId t2) {
