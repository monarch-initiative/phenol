...
public class UberphenoOboParserTest {
  ...
  @Test
  public void testParseUphenoHead() throws IOException {
    final UphenoOboParser parser = new UphenoOboParser(uberphenoHeadFile, true);
    final UphenoOntology ontology = parser.parse();
    ...
    assertEquals(
        "{ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=1]=UphenoTerm [id=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=1], altTermIds=[], name=All, definition=null, comment=null, subsets=[], synonyms=[], obsolete=false, createdBy=null, creationDate=null], ImmutableTermId [prefix=ImmutableTermPrefix [value=MP], id=1]=UphenoTerm [id=ImmutableTermId [prefix=ImmutableTermPrefix [value=MP], id=1], altTermIds=[], name=mammalian phenotype, definition=null, comment=null, subsets=[], synonyms=[], obsolete=false, createdBy=null, creationDate=null], ImmutableTermId [prefix=ImmutableTermPrefix [value=MP], id=1186]=UphenoTerm [id=ImmutableTermId [prefix=ImmutableTermPrefix [value=MP], id=1186], altTermIds=[], name=pigmentation phenotype, definition=null, comment=null, subsets=[], synonyms=[], obsolete=false, createdBy=null, creationDate=null], ImmutableTermId [prefix=ImmutableTermPrefix [value=UBERPHENO], id=1]=UphenoTerm [id=ImmutableTermId [prefix=ImmutableTermPrefix [value=UBERPHENO], id=1], altTermIds=[], name=UBERPHENO_ROOT, definition=null, comment=null, subsets=[], synonyms=[], obsolete=false, createdBy=null, creationDate=null], ImmutableTermId [prefix=ImmutableTermPrefix [value=ZP], id=1]=UphenoTerm [id=ImmutableTermId [prefix=ImmutableTermPrefix [value=ZP], id=1], altTermIds=[], name=abnormal(ly) quality zebrafish anatomical entity, definition=null, comment=null, subsets=[], synonyms=[], obsolete=false, createdBy=null, creationDate=null]}",
        ImmutableSortedMap.copyOf(ontology.getTermMap()).toString());
    assertEquals(
        "{1=UphenoTermRelation [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=MP], id=1], dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=UBERPHENO], id=1], id=1, relationQualifier=IS_A], 2=UphenoTermRelation [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=HP], id=1], dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=UBERPHENO], id=1], id=2, relationQualifier=IS_A], 3=UphenoTermRelation [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=ZP], id=1], dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=UBERPHENO], id=1], id=3, relationQualifier=IS_A], 4=UphenoTermRelation [source=ImmutableTermId [prefix=ImmutableTermPrefix [value=MP], id=1186], dest=ImmutableTermId [prefix=ImmutableTermPrefix [value=MP], id=1], id=4, relationQualifier=IS_A]}",
